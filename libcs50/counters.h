...
/**************** counters_size ****************/
/* Count the number of keys in counter structure
 * 
 * Caller provides:
 *   valid pointer to counterset
 * 
...
/**************** counters_copy ****************/
/* copy one counter into another
 * 
 * Caller provides:
 *   valid pointer to counterset arg
 *   the key we are currently iterating on
 *   the value for the key
 * 
 * We do:
 *   copy these keys and counts into arg
 */
